...
namespace App\Http\Controllers\Touronkai\Attendee;
...
class RegisterController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->form = config('pacd.form.type.touronkai_attendee');
    ...
    public function store($event_code, Request $request)
    {
        ...
        $set['edit_url'] = route('touronkai_attendee.edit', [$attendee->id]);
        $set['create_url'] = route('touronkai_presenter', [$attendee->id]);
