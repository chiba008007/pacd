...
namespace App\Http\Controllers\Touronkai\Presenter;
...
class UpdateController extends Controller
{
    ...
    public function update($presenter_id, Request $request)
    {
        ...
        ->update([
            ...
            'daimoku'=>$request->daimoku,
            'enjya'=>$request->enjya,
            'enjya1'=>$request->enjya1,
            'enjya2'=>$request->enjya2,
            'enjya3'=>$request->enjya3,
            'enjya4'=>$request->enjya4,
            'enjya5'=>$request->enjya5,
            'enjya6'=>$request->enjya6,
            'syozoku1'=>$request->syozoku1,
            'syozoku2'=>$request->syozoku2,
            'syozoku3'=>$request->syozoku3,
            'syozoku4'=>$request->syozoku4,
            'syozoku5'=>$request->syozoku5,
            'syozoku6'=>$request->syozoku6,
            'enjya_other'=>$request->enjya_other,
            'syozoku'=>$request->syozoku,
            'gaiyo'=>$request->gaiyo,
        ]);
    ...
    public function complete($presenter_id)
    {
        ...
        $set['create_url'] = route('touronkai_presenter', $this->attendee->id);
        $set['edit_url'] = route('touronkai_presenter.edit', $this->presenter->id);
