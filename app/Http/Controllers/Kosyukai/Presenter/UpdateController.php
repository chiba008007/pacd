...
class UpdateController extends Controller
{
    ...
    public function __construct()
    {
        ...
        if ($current) {
            ...
            if ($this->event->category_type != config('pacd.category.kosyukai.key')) {
                abort(404);
            }
    ...
    public function complete($presenter_id)
    {
        ...
        $set['create_url'] = route('kosyukai_presenter', $this->attendee->id);
        $set['edit_url'] = route('kosyukai_presenter.edit', $this->presenter->id);
