...
class KosyukaiController extends Controller
{
    ...
    {
        //カテゴリタイプの指定
        $this->category_prefix = config('pacd.category.kosyukai.prefix');
        $this->category_type = config('pacd.category.kosyukai.key');
        $this->category_title = config('pacd.category.kosyukai.name');
    ...
    public function event_list(Request $request){
        ...
        $events = $events->orderby("date_start","desc")
        ->paginate($this->page);
