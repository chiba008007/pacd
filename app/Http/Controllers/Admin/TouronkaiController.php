...
class TouronkaiController extends Controller
{
    public $page = 5;
    ...
    {
        //カテゴリタイプの指定
        $this->category_prefix = config('pacd.category.touronkai.prefix');
        $this->category_type = config('pacd.category.touronkai.key');
        $this->category_title = config('pacd.category.touronkai.name');
