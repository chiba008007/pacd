...
class FormDataPresenter extends Model
{
    use HasFactory;
     ...
     * @return void
     */
    static public function createFromInputData(array $data, Presenter $presenter)
    {
        try {
     ...
     * @return void
     */
    static public function updateFromInputData(array $data, Presenter $presenter)
    {
        try {
            $custom_data = $presenter->custom_form_data->keyBy('form_input_value_id');
            foreach ($data as $input_id => $input) {
                if (isset($input['data'])) {
                    foreach ($input['data'] as $value_id => $val) {
