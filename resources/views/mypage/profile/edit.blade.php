    ...
    <div id="page">
        ...
        <div class="uk-container uk-section-xsmall">
            ...
            <form method="POST" action="{{ route('mypage.profile.update') }}" class="uk-form-horizontal uk-margin-medium-top" id="user_update_form">
                @csrf
                @method('put')
                @include('elements.forms.members.common',["user"=>$user,"isprofile"=>true,"isedit"=>true])
                <div class="uk-section-small uk-text-center">
                    <button type="submit" class="uk-button uk-button-primary bg-green" form="user_update_form">会員情報変更</button>
                </div>
                ...
                <fieldset class="uk-fieldset">
                    ...
                    <div class="uk-margin">
                        <label class="uk-form-label uk-text-left" for="login_id">
                            会員ID<span class="uk-label uk-label-danger uk-margin-small-left">必須</span>
                        </label>
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <div class="uk-margin-small">
                                ※ パスワードの変更は <a href="{{ route('mypage.profile.edit.password', $user->id) }}">こちら</a> から
                            </div>
                        </div>
                    </div>
